import * as zt100 from '/static/lib/zt100.js';
      ...
      <div class="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
        <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
          <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
            <span class="block xl:inline"><${zt100.Editable} key="hero1" overrides=${attrs.overrides} section=${attrs.section}>Data to enrich your<//></span>
            <span class="block text-primary-600 xl:inline"><${zt100.Editable} key="hero2" overrides=${attrs.overrides} section=${attrs.section}>online business<//></span>
          </h1>
          <p class="mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
          <${zt100.Editable} key="hero3" overrides=${attrs.overrides} section=${attrs.section}>Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.<//>
          </p>
